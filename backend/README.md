...
## Project Structure
    ...
    ├── natures_cornucopia_30308  # Django project configurations
...
1. Clone this repo and `cd natures_cornucopia_30308`
...
2. Clone this repo and `cd natures_cornucopia_30308`
